...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MVC_T2.Models.Department", b =>
                {
            ...
            modelBuilder.Entity("MVC_T2.Models.DepartmentLocation", b =>
                {
            ...
            modelBuilder.Entity("MVC_T2.Models.Dependent", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MVC_T2.Models.Employee", b =>
                {
                    b.Property<int>("SSN")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MVC_T2.Models.Project", b =>
                {
                    b.Property<int>("Number")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MVC_T2.Models.WorkOnProject", b =>
                {
                    b.Property<int>("EmpSSN")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MVC_T2.Models.DepartmentLocation", b =>
                {
                    b.HasOne("MVC_T2.Models.Department", "Department")
            ...
            modelBuilder.Entity("MVC_T2.Models.Dependent", b =>
                {
                    b.HasOne("MVC_T2.Models.Employee", "Employee")
                        .WithMany("Dependents")
            ...
            modelBuilder.Entity("MVC_T2.Models.Employee", b =>
                {
                    b.HasOne("MVC_T2.Models.Employee", "Supervisor")
                        .WithMany("Employees")
            ...
            modelBuilder.Entity("MVC_T2.Models.WorkOnProject", b =>
                {
                    b.HasOne("MVC_T2.Models.Employee", "Employees")
                        .WithMany("WorksOnProjects")
                        .HasForeignKey("EmployeesSSN");

                    b.HasOne("MVC_T2.Models.Project", "Project")
